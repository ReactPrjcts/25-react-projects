...
const data = [
  {title: "What are 25-react-projects components?", text: "Anyone who is young. Take the time and do these. I'm old now and life makes it harder to learn.  It's impossible to sit down. For more than 1 or 2 hours and study. Too much obligations."},
  ...
  {title: "Can I create an 25-react-projects component?", text: "On the 'Star Rating\" project, if you had trouble changing colors on the \"hover' and 'mouseover' states, another way to do it is to have two sets of stars you can toggle between. For example, if a user clicks, or their "}]
